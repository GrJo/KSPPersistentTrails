...
namespace PersistentTrails
{
    public class AppLauncherToolBar
    {
        ...
        {
            Utilities.debug.debugMessage("OnGUIAppLauncherReady");
            if (ApplicationLauncher.Ready)
            {
                Utilities.debug.debugMessage("Adding AppLauncherButton");
        ...
        {
            Utilities.debug.debugMessage("Adding onGUIAppLauncher callbacks");
            if (ApplicationLauncher.Ready)
            {
                if (stockToolbarButton == null)
        ...
        private void OnGameSceneLoadRequestedForAppLauncher(GameScenes SceneToLoad)
        {
            if (stockToolbarButton != null)
            {
                ...
                Utilities.debug.debugMessage("TSTMenu AppLauncher: Destroying Button-Button Count:" + lstButtons.Length);
                ApplicationLauncher.Instance.RemoveModApplication(stockToolbarButton);
                stockToolbarButton = null;
            }
        }
        ...
        public void Destroy()
        {
            ...
            // Stock toolbar
            Utilities.debug.debugMessage("Removing onGUIAppLauncher callbacks");
